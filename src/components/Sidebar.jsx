...
const Sidebar = () => {
  ...
  const navItems = [
    ...
    { path: '/emergency-reports', label: 'Emergency Reports', icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z' },
...
<Link
        ...
        <button
          ...
          className="flex items-center justify-center w-full h-10 gap-2 mt-4 text-sm font-bold leading-normal tracking-[0.015em] bg-red-50 text-red-600 rounded-lg hover:bg-red-100 transition-colors"
        >
